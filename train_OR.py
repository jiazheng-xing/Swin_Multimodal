...
def main():
    ...
    for epoch in range(start_epoch, config.solver.epochs):
        ...
        for kkk,(images,list_id) in enumerate(tqdm(train_loader)):
            ...
            image_embedding = fusion_model(image_embedding) #(96,512)   
            # print("*"*100)
            # print("OUT_embedding:{}".format(image_embedding.shape))
            # print("*"*100)
           # print("fusion_model_fc_parameters:{}".format(fusion_model.module.fc].weight))
            # import pdb
            # pdb.set_trace()
            #print("fusion_model:{}".format(fusion_model.module.model.transformer.resblocks[0].mlp.c_fc.weight))
            # print("fusion_model:{}".format(fusion_model.module.transformer.resblocks[0].mlp.c_fc.weight))
            # print("model:{}".format(model.visual.conv1.weight[-1][-1]))
